...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug 31 22:31:55 2023
...
#This fuction is required because the nn LayerNormalisation does not have bias=0
...
class PositionalEmbedding(nn.Module):
    def __init__(self, d_model: int, seq_len: int, dropout: float):
        ...
        #pe is stored and not back propogated
    def forward(self, x):
